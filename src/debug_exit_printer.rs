...
use crate::backend::background_thread::{TOTAL_TRIMMED_BLOCKS, TOTAL_TRIMMED_TIME};
...
use crate::{
    ...
    backend::background_thread::{DISABLE_SEGMENTED_BITMAP, TOTAL_TRIM_CALLS, TOTAL_TRIMMED_VA},
